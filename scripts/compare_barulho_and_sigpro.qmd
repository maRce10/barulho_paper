...
options(mc.cores = 20)
est_sigpro_subdata$sound.id <- est_sigpro_subdata$signal.type
est_sigpro_subdata <- set_reference_sounds(est_sigpro_subdata)

est_sigpro_subdata <- signal_to_noise_ratio(est_sigpro_subdata, mar = 0.02, pb = FALSE, wl = 512, ovlp = 50)
source("~/Dropbox/R_package_testing/baRulho/R/internal_functions.R")
source("~/Dropbox/R_package_testing/baRulho/R/blur_ratio.R")

est_sigpro_subdata <- blur_ratio(est_sigpro_subdata, pb = FALSE, wl = 512, ovlp = 50)

source("~/Dropbox/R_package_testing/baRulho/R/tail_to_signal_ratio.R")

est_sigpro_subdata <- tail_to_signal_ratio(est_sigpro_subdata, pb = FALSE,  mar = 0.04,wl = 512, ovlp = 0)

source("~/Dropbox/R_package_testing/baRulho/R/excess_attenuation.R")

est_sigpro_subdata <- excess_attenuation(X = est_sigpro_subdata, pb = FALSE, ovlp = 50, wl = 1024)
...
write.csv(comb_data_cols, "./data/processed/combined_sigpro_barulho_oct_2024.csv", row.names = FALSE)
...
# ggsave(plot = combined_gg, filename = "./output/barulho_vs_sigpro.tiff", dpi =  300, width = 7, height = 4)
