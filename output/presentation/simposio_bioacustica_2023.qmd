...
<font size="20"><b><a href="https://marce10.github.io/baRulho/">baRulho</a></b></font>

<br/>

<font size=20>**Un paquete de R para cuantificar la de degradación de sonidos animales <br/>inducida por el ambiente**</font>

<br/>
<font size=6><b>Marcelo Araya-Salas</b> (Universidad de Costa Rica)</font><br/> 
<font size=6>Erin E. Grabarczyk (Valdosta State University)</font><br/> 
<font size=6>Marcos Quiroz-Oliva (Universidad de Costa Rica)</font><br/> 
<font size=6>Adrián García-Rodríguez (Universidad de Vienna)</font><br/> 
<font size=6>Alejandro Rico-Guevara (Universidad de Washington)</font>
...
## {visibility="uncounted" background-color="white" background-image="images/background.png"}
...
## El paquete `baRulho` {background="#31688EFF"}
...
## Objetivos {background="#31688EFF"}

<br/>

<font color = "#FD9567"><b>1. Estudio: efectos del hábitat y la estructura de la señal en la transmisión mediante sonidos sintetizados</b></font>

<br/>

<font color = "#FD9567"><b>2. Comparar `baRulho` y `Sigpro`</b></font>
...
## Sintetizar sonidos de tipo animal {background-color="white" background-image="images/background.png"}
...
![](images/tlalpan3.jpg){.absolute top=160 left=0 width=1500}
...
![](images/tlalpan2.jpg){.absolute top=160 left=0 width=1500}

![](images/playback_exp.png){.absolute top=320 left=170 width=600}
...
## Visualizar degradación {background-color="white" background-image="images/background.png"}
...
## Cuantificar degradación {background-color="white" background-image="images/background.png"}
...
_medida de degradación ~ habitat + frec + duración + am + fm_
...
![](images/blue_line.png){.absolute top=120 left=430 width=520}
![](images/orange_line.png){.absolute top=120 left=50 width=260}
...
- Cuantificación precisa ![](images/frog_degrad_gray.png){.absolute top=130 left=480 width=180} 

<br/>


- Mejor desempeño ![](images/clock_gray.png){.absolute top=300 left=380 width=160} 

<br/>

- Expande la caja de herramientas ![](images/toolkit_gray.png){.absolute top=480 left=610 width=140}



## Agradecimientos {background-color="white" background-image="images/barulho_sticker_no_text.png"}
...
<center><font size="20"><b><a href="https://marce10.github.io/baRulho/">Paquete de R baRulho</a></b></font></center>


![](images/QR_code_baRulho R package.png){.absolute top=120 left=280 width="520"}
