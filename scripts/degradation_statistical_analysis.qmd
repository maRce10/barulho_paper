...
null_mod_pc1 <-
brm(
formula = pc1 ~ 1 + (1 | location) + (1 | treatment.replicates),
data = degrad_df,
prior = null_priors,
iter = iter,
chains = chains,
...
null_mod_blurratio <-
    brm(
        formula = blur.ratio ~ 1 + (1 | location) + (1 | treatment.replicates),
        data = degrad_df,
        prior = null_priors,
        iter = iter,
        chains = chains,
...
null_mod_ea <-
    brm(
        formula = excess.attenuation ~ 1 + (1 | location) + (1 | treatment.replicates),
        data = degrad_df,
        prior = null_priors,
        iter = iter,
        chains = chains,
...
null_mod_tsr <-
    brm(
        formula = tail.to.signal.ratio ~ 1 + (1 | location) + (1 | treatment.replicates),
        data = degrad_df,
        prior = null_priors,
        iter = iter,
        chains = chains,
